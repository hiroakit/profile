...
#+begin_src sh
/bin/zsh -c "$(curl -fsSL https://raw.githubusercontent.com/hiroakit/xclt/HEAD/xclt.sh)" && git clone https://github.com/hiroakit/profile --recursive && cd profile && sh install.sh
#+end_src
